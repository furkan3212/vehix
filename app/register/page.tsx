  ...
  return (
    <main className="relative min-h-screen overflow-hidden bg-[#020617] text-white">
      ...
      <div className="pointer-events-none absolute inset-0">
        ...
        <div className="absolute -bottom-40 -right-40 h-[520px] w-[520px] rounded-full bg-cyan-500/10 blur-[150px]" />
        <div className="absolute left-1/2 top-1/2 h-[320px] w-[320px] -translate-x-1/2 -translate-y-1/2 rounded-full bg-blue-500/5 blur-[130px]" />
      </div>
      ...
      <div className="relative z-10 mx-auto flex min-h-[calc(100vh-100px)] w-full max-w-7xl items-center justify-center px-6 py-10">
        <div className="grid w-full max-w-5xl overflow-hidden rounded-[32px] border border-white/10 bg-white/[0.025] shadow-2xl shadow-black/50 backdrop-blur-2xl lg:grid-cols-[0.95fr_1.05fr]">

          {/* LEFT */}
          <div className="relative hidden overflow-hidden border-r border-white/10 bg-gradient-to-br from-blue-600/[0.09] via-transparent to-cyan-500/[0.04] p-12 lg:flex lg:flex-col lg:justify-between">
            ...
            <div className="relative">
              ...
              <p className="mt-6 max-w-md text-base leading-7 text-zinc-400">
                Create your VEHIX account and bring your vehicle,
                documents, QR identity and essential information
                ...
                {password && (
                  <div className="mt-3">
                    ...
                    <p className="mt-2 text-[11px] text-zinc-600">
                      Use 6+ characters. A longer password with
              ...
              <div className="rounded-2xl border border-white/10 bg-black/20 px-4 py-4">
                <label className="flex cursor-pointer items-start gap-3">
                  <input
                    ...
                    className="mt-1 h-4 w-4 shrink-0 cursor-pointer rounded border-white/20 bg-black/30 accent-blue-600"
                  />
